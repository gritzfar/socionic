        ...
        SliverToBoxAdapter(
            child: Container(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: <Widget>[
                  ...
                  Text(
                      "    Ячейки 1, 2, 3 и 4 называются ментальным кольцом. Это наше сознание. Эти функции осознаются человеком постоянно, ими он пользуется сознательно. С помощью ментальных функций возможно не только решать конкретные жизненные задачи, но и мыслить абстрактно, делать обобщения между различными задачами, сопоставлять их между собой.\r\n    Ячейки 5, 6, 7 и 8 нызваются витальным кольцом. Это наше подсознание. Эти функции работают вне зависимости от нашего сознания и направлены на решение каких-то локальных задач здесь и сейчас. И повлиять на их работу сложнее. Хотя переключение сознания на функции витального кольца в принципе возможно, но оно требует целенаправленных усилий и сознательного контроля, и возможно только на короткое время. Как только контроль ослабевает, происходит обратное переключение сознания на функции ментального кольца."),
                  Text(""),
                  Text("Мерность функций", style: titleStyle, textAlign: TextAlign.center),
                  Text(
                      "    Функции могу быть разных мерностей, от 1 до 4. Чем больше мерность, тем глубже и экспертнее фукция.\r\n    Функции 1 и 8 имеют мерность 4. Это самые сильные и экспертные функции. Они видят информацию во всем её объеме и полноте. Обучение по ней происходит легко, без особых энерго затрат.\r\n    Функции 2 и 7 имеют мерность 3. Это функции также сильные, но менее экспертны, и применяться ситуативно, творческий, привнося в мир новые решения.\r\n    Функции 3 и 6 имеют мерность 2. Функции в этих блоках слабые, поле информации видится поверхностно. Но тем не менее они обучаемы. Кроме прожитого опыта, могут использовать и опосредованный опыт: из объяснения других людей, из книг, усваивать нормы, принятые в том или ином сообществе, однако в дальнейшем полученный опыт используется шаблонно, без переработки его под специфику новой ситуации.\r\n    Функции 4 и 5 имеют мерность 1. Они имеют очень слабое виденье поля информации, обучение происходит только на собсвенном опыте. Иными словами, человек учится только на своих ошибках, а попытки объяснить что-то приводят к тому, что \"в одно ухо влетает, в другое – вылетает\"."),
                  Text(""),
